    ...
    while ($reg = mysqli_fetch_assoc($registro)){
        ...
        echo "</pre>";
            ...
            if ($item['nom_pro'] == $item['pro_pro'] && $item['pro_ord'] == $item['act_pro']) {
                ...
                echo "<th>".$item['id_ind']."</th><th>".$item['nro_ord']."</th><th>".$item['nom_usu']."</th><th>".$item['nom_pro']."</th>";
                echo "<th>".$item['can_rea']."</th><th>".$item['can_tot']."</th><th>".$tot_efi." % </th>";
                echo "<th>".$item['nom_pro']."</th><th>".$item['pro_pro']."</th><th>".$item['pro_ord']."</th><th>".$item['act_pro']."</th></tr>";
                
        
            } else {
                echo "El estándar no corresponde con la orden para ID Indicador: " . $item['id_ind'] . " ".$item['nom_pro']."".$item['pro_pro']."".$item['pro_ord']."".$item['act_pro']."<br><br>";
            }
        }
