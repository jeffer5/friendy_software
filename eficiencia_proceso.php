...
<body>
 ...
 <?php
    ...
    $registro = mysqli_query($conex,"SELECT i.id_ind, i.can_rea, i.tie_gas, i.fec_ind , p.id_pro, p.act_pro, p.pro_pro, p.can_pro, p.tie_pro,d.id_det ,d.id_usu_fk, d.id_ord_fk,
                                      u.id_usu, u.nom_usu, u.ape_usu, o.id_ord, o.nro_ord, o.nom_pro, o.can_tot, o.pro_ord
                                     FROM indicador i
                                     ...
                                     WHERE o.pro_ord ='$_REQUEST[proceso] ' ")or die ("error".mysqli_error($conex));
    ...
    while ($reg = mysqli_fetch_assoc($registro)){
        ...
        $datos[$reg['id_ind']] = $reg;
                ...
                echo "<tr><th>ID Indicador</th><th>Numero Orden</th><th>Usuario</th><th>Producto</th><th>Cantidad realizada</th><th>Cantidad total</th><th>Proceso</th><th>Eficiencia</th></tr>";
            ...
            if ($item['nom_pro'] == $item['pro_pro'] && $item['pro_ord'] == $item['act_pro']) {
                ...
                echo "<th>".$item['can_rea']."</th><th>".$item['can_tot']."</th><th>".$item['pro_ord']."</th><th>".$tot_efi." % </th></tr>";
